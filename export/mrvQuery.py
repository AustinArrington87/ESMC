...
#file = open('TNCMN_export2.25.22.json')
file = open('MOCS_export2.25.22.json')
#file = open('Corteva_export.1.26.22.json')
#file = open('ICG_export.1.26.22.json')
data = json.load(file)
...
for crop in enrollment_crops:
    ...
    if crop[0] == 'Hay/Alfalfa':
        hay_acres.append(crop[1])
    if crop[0] == 'Sorghum':
        sorghum_acres.append(crop[1])
...
print(str(enrollment_year),"Total Hay/Alfalfa Harvest:", removeNull(hay_acres), "tons/acre")
print(str(enrollment_year),"Sorghum Crop Harvest:", removeNull(sorghum_acres), "bu/acre")
