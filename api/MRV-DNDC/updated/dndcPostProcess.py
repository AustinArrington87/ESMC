...
class Process:
    ...
    def __init__(self, dndcFilename):
        ...
        try:
            ...
            for field in dndcJson['data']['session_uncertainties']:
                ...
                if self.directn2oAggregatedBaselineDistribution:
                    self.directn2oAggregatedBaselineDistribution = [x + y for x, y in zip(self.dsocAggregatedBaselineDistribution, self.dsocBaselineDistributions[field])]
                else:
                    self.directn2oAggregatedBaselineDistribution = self.dsocBaselineDistributions[field]
